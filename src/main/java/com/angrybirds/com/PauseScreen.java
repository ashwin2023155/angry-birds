...
public class PauseScreen implements Screen {
    ...
    private static final float BUTTON_Y_OFFSET = 0.832f;
    private int currentLevel;  // Percentage from bottom for close button

    // Constants for give up button positioning
    private float giveUpXOffset = 0.700f; // Percentage from left for give up button
    private float giveUpYOffset = 0.1f;
    private com.badlogic.gdx.InputProcessor previousInputProcessor; // Percentage from bottom for give up button
    ...
    private void setupCloseButton() {
        ...
        closeButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                game.setScreen(game.getCurrentGameScreen());
            }
        });
